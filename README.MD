The intent of this optimization project is to minimize distance traveled by technician while fulfilling as many jobs as possible in order to improve the number of case closed per day.
